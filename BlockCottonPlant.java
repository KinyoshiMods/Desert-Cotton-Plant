...
public class BlockCottonPlant extends Block
{
    protected BlockCottonPlant(int par1)
    {
 ...
 //   }
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return var5 == this.blockID ? true : (var5 != Block.sand.blockID && var5 != Block.sand.blockID && var5 != Block.sand.blockID ? false : (par1World.getBlockMaterial(par2 - 1, par3 - 1, par4) == Material.sand ? true : (par1World.getBlockMaterial(par2 + 1, par3 - 1, par4) == Material.sand ? true : (par1World.getBlockMaterial(par2, par3 - 1, par4 - 1) == Material.sand ? true : par1World.getBlockMaterial(par2, par3 - 1, par4 + 1) == Material.sand))));
    }
    ...
    {
        return mod_DesertCotton.BlockCottonPlant.blockID;
    }
